(async () => {
    ...
    const selectedTimestream = await showDialog('Chronoskimmer Initiative', (() => {
    ...
    })(), '#selected-timestream', timestreams);
                    ...
                    const result = await (async () => {
                        ...
                        const html = (() => {
                            ...
                            if (!(element instanceof HTMLElement))
                                throw ErrorPF2e('Unexpected error parsing HTML');
                            return element;
                        })();
                        const convertXMLNode = (html, name, { visible = undefined, visibility = undefined, whose = 'self', classes = [] }) => {
    ...
    const roll = new Roll(`1d20${signedMod}`, {}, {
